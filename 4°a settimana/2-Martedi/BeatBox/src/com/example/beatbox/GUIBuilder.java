...
public class GUIBuilder {
    ...
    private Box buildButtonBox(){
        ...
        JButton upTempoButtom = new JButton("Tempo Up");
        upTempoButtom.addActionListener(e -> player.changeTempo(1.03f));
        buttonBox.add(upTempoButtom);

        JButton downTempoButtom = new JButton("Tempo Down");
        downTempoButtom.addActionListener(e -> player.changeTempo(0.97f));
        buttonBox.add(downTempoButtom);
