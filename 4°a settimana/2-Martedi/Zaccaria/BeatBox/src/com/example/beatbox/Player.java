...
public class Player {
    ...
    public void makeTracks(int[] list) {
        ...
        track.add(makeEvent(ShortMessage.CONTROL_CHANGE, 1, 0, 0, list.length));
    }
    ...
    public void play(int beats) {
        // per essere sicuri di avere un evento al beat 16 (indice 15)
        track.add(
            makeEvent(
                ShortMessage.PROGRAM_CHANGE, 9, 1, 0, beats - 1
            )
        );
